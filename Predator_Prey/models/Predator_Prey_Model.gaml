...
* Based on the Predator Prey Tutorial
* Author: marco
* Tags: 
*/
...
//experiment FirstModel type: test autorun: true {
	/** Alternatively or in addition, you can insert here tests definitions */

//}

// image_file my_icon <- image_file("../includes/images/predator_prey_sheep.png");
// image_file my_icon <- image_file("../includes/images/predator_prey_wolf.png");
...
global {
    ...
    file map_init <- image_file("../includes/images/predator_prey_raster_map.png");
